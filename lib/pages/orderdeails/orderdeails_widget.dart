...
import 'orderdeails_model.dart';
export 'orderdeails_model.dart';

class OrderdeailsWidget extends StatefulWidget {
  const OrderdeailsWidget({
    Key? key,
    this.propertyRef,
    this.tripRef,
  }) : super(key: key);
  ...
  @override
  _OrderdeailsWidgetState createState() => _OrderdeailsWidgetState();
}

class _OrderdeailsWidgetState extends State<OrderdeailsWidget> {
  late OrderdeailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrderdeailsModel());
  }
                    ...
                    Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Text(
                              'Mark this order as complete below.',
